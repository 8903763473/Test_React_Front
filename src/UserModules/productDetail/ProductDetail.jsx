                                            ...
                                            <div className="details-product-area">
                                                <div className="product-thumb-area">
                                                    ...
                                                    <div className="thumb-wrapper one filterd-items figure">
                                                        <div className="product-thumb zoom" onmousemove="zoom(event)" style={{ backgroundImage: `url(${prodDetail.productImage})` }}><img src={prodDetail.productImage} alt="product-thumb" />
                                                        </div>
                                                    </div>
                                                    {/* <div className="thumb-wrapper two filterd-items hide">
                                                        <div className="product-thumb zoom" onmousemove="zoom(event)" style={{ backgroundImage: `url(images/shop/02.jpg)` }}><img src="images/shop/02.jpg" alt="product-thumb" />
                                                        </div>
                                                    </div>
                                                    <div className="thumb-wrapper three filterd-items hide">
                                                        <div className="product-thumb zoom" onmousemove="zoom(event)" style={{ backgroundImage: `url(images/shop/03.jpg)` }}><img src="images/shop/03.jpg" alt="product-thumb" />
                                                        </div>
                                                    </div>
                                                    <div className="thumb-wrapper four filterd-items hide">
                                                        <div className="product-thumb zoom" onmousemove="zoom(event)" style={{ backgroundImage: `url(images/shop/04.jpg)` }}><img src="images/shop/04.jpg" alt="product-thumb" />
                                                        </div>
                                                    </div>
