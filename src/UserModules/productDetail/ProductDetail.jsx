                                            ...
                                            <div class="details-product-area">
                                                <div class="product-thumb-area">
                                                    ...
                                                    <div class="thumb-wrapper one filterd-items figure">
                                                        <div class="product-thumb zoom" onmousemove="zoom(event)" style={{ backgroundImage: `url(${prodDetail.productImage})` }}><img src={prodDetail.productImage} alt="product-thumb" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="contents">
                                                    <div class="product-status">
                                                        <span class="product-catagory">{prodDetail.productDiscount} % Off</span>
                                                    ...
                                                    <h2 class="product-title d-flex">{prodDetail.productName}</h2>
                                                    <p class="mt--20 mb--20 d-flex text-justify">
                                                        {prodDetail.productDescription}
                                                    </p>
                                                    <span class="product-price mb--15 d-block text-justify" style={{ color: '#DC2626', fontWeight: 600 }}> ₹ {quantity * prodDetail.productCurrentRate}<span class="old-price ml--15">₹ {prodDetail.productOriginalRate}</span></span>
                                                    <div class="product-bottom-action">
                                                        <div class="cart-edits">
                                                            <div class="quantity-edit action-item" style={{ width: 'auto' }}>
                                                                <button class="button" onClick={decreaseQuantity}>
                                                                ...
                                                                <input
                                                                    ...
                                                                    readOnly
                                                                />
                                                                <button class="button plus" onClick={increaseQuantity}>
                                                                    +<i class="fal fa-plus plus"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <a class="rts-btn btn-primary radious-sm with-icon" onClick={() => addCart(prodDetail)} style={{ cursor: 'pointer' }}>
                                                            <div class="btn-text" >
                                                                Add To Cart
                                                            </div>
                                                        ...
                                                        {/* <a  class="rts-btn btn-primary ml--20"  ><i class="fa-light fa-heart"></i></a> */}
                                                    </div>
                                                    <div class="product-uniques" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', flexDirection: 'column' }}>
                                                        <span class="sku product-unipue mb--10"><span className='prodDetailText'>Status: </span> {prodDetail.productStatus}</span>
                                                        {/* <span class="catagorys product-unipue mb--10"><span className='prodDetailText'>Categories: </span> {prodDetail.productCategory}</span> */}
                                                        {/* <span class="tags product-unipue mb--10"><span className='prodDetailText'>Tags: </span> fashion, t-shirts, Men</span> */}
                                                        <span class="tags product-unipue mb--10"><span className='prodDetailText'>Unit: </span> {prodDetail.productQuantity} {prodDetail.productUnit}</span>
                                                        {/* <span class="tags product-unipue mb--10"><span className='prodDetailText'>Type: </span> original</span> */}
                                                        <span class="tags product-unipue mb--10"><span className='prodDetailText'>Category: </span> {prodDetail.productCategory}</span>
                                                    </div>
                                                    <div class="share-option-shop-details">
                                                        <div class="single-share-option" onClick={() => addToWishlist(prodDetail)}>
                                                            <div class="icon"  >
                        ...
                        <div class="col-lg-12">
                            ...
                            "1540":{
                                ...
                                "spaceBetween":16}
                                    ...
                                    <div class="swiper-wrapper cardWrapper">

                                        {
                                            RelatedProduct.map((res,index) => (
                                                <div class="swiper-slide cardSlide" key={index}>
                                                    <div class="single-shopping-card-one">
                                                        <div class="image-and-action-area-wrapper" style={{ minHeight: '200px', maxHeight: '200px' }}>
                                                            <a class="thumbnail-preview d-flex align-items-center justify-content-center" style={{ height: '200px' }}>
                                                                <div class="badge">
                                                                    <span>{res.productDiscount} % <br /> Off</span>
                                                                    <i class="fa-solid fa-bookmark"></i>
                                                                </div>
                                                                <img src={res.productImage} alt={res.productName} style={{ width: '50%' }} />
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist" onClick={() => addToWishlist(res)}>
                                                        ...
                                                        <div class="body-content">
                                                            ...
                                                            <a >
                                                                <h4 class="title d-flex">{res.productName}</h4>
                                                            </a>
                                                            <span class="availability d-flex color-green">{res.productStatus}</span>
                                                            <div class="price-area d-flex justify-content-flex-start">
                                                                <span class="current">₹ {res.productOriginalRate}</span>
                                                                <div class="previous">₹ {res.productCurrentRate}</div>
                                                            </div>
                                                            <div class="cart-counter-action">
                                                                ...
                                                                <a class="rts-btn btn-primary radious-sm with-icon" onClick={() => addCart(res)} style={{ cursor: 'pointer' }}>
                                                                    <div class="btn-text">
                                                                        Add To Cart
                                                                    </div>
                                                                    <div class="arrow-icon">
