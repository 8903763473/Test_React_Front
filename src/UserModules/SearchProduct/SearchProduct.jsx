    ...
    return (
        <div>
            ...
            <div class="shop-grid-sidebar-area rts-section-gap">
                <div class="container">
                    <div class="row g-0">
                        <div class="col-xl-3 col-lg-12 pr--25 pr_lg--10 pr_sm--10 pr_md--5 rts-sticky-column-item">
                        ...
                        <div class="col-xl-9 col-lg-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="product-area-wrapper-shopgrid-list mt--20 tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                    <div class="row g-4 allCard">
                                        {SearchData.map((category, index) => (
                                            <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12 mt-8">
                                                <div class="single-shopping-card-one" style={{ height: 'auto', width: '230px' }}>
                                                        ...
                                                        <div class="cart-counter-action">
                                                            <div class="quantity-edit" style={{ display: 'flex', alignItems: 'space-around', justifyContent: 'center' }}>
                                                                ...
                                                                <div class="button-wrapper-action">
                                                                    <button class="button" onClick={() => DecreaseQuantity(index)}><i class="fa-regular fa-chevron-down"></i></button>
                                                                    <button class="button plus" onClick={() => IncreaseQuantity(index)}>+<i class="fa-regular fa-chevron-up"></i></button>
                                                                </div>
                                                            </div>
                                        ...
                                        {SearchData.map((category, index) => (
                                            <div class="col-lg-6">
                                                <div class="single-shopping-card-one discount-offer">
                                                    <a class="thumbnail-preview" style={{ width: '100%' }}>
                                                        <div class="badge">
                                                            <span>{category.productDiscount} % <br />
                                                                Off
                                                            </span>
